...
public class AdminController {
    ...
    public ResultVO deleteTeacher(@RequestAttribute String number) {
    ...
    public ResultVO getTeacherByname(@RequestAttribute String name) {
    ...
    @ApiOperation("删除实验室")
    @PostMapping("deletelabs")
    public ResultVO deleteLab(@RequestAttribute String name) {
        laboratoryService.deleteLab(name);
        return ResultVO.success(Map.of("deletelabs",name));
    }
    @ApiOperation("获取全部课程")
    ...
    public ResultVO getCourse(@RequestAttribute Long sid) {
